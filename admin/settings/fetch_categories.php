...
$query = "SELECT COUNT(*) FROM tour_categories AS t "
        . "WHERE 1 AND ".$filter;
...
$query = "SELECT * FROM tour_categories AS t "
        . "WHERE 1 AND ".$filter." "
...
while($categories_data = $fetch_data->fetch_assoc()){ //fetch values
    ...
    <tr id="tr_{$categories_data['id']}" style="border:1px solid #000000;">
        ...
        <td>
            <center>
                <input type="button" class="small button" value="Edit" onclick="editCategories({$categories_data['id']})" style="margin-bottom: -5px;" />
            </center>
        </td>
        <td>
            <center>
                <input type="button" class="small button" value="Delete" onclick="deleteCategories({$categories_data['id']})" style="margin-bottom: -5px;"/>
            </center>
        </td>
    </tr>
HEREDOC;
           ...
           <th colspan="6">
                ...
                <section>
                    ...
                    <span style="float: left;padding-left: 22px;margin-top: -5px;">
                        <a href="add_categories.php" class="small button">Add New Category</a>
                    </span>
