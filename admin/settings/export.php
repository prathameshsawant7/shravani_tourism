...
<!--    <link href="../css/progressbar_static.min.css" rel="stylesheet"/>
    ...
    <div class="row">
        ...
        <h3 style="color: #000"><center>Product Export</center></h3>
        
        <label id="data" style="display: none"></label>
        <table>
            <tbody>
                <tr>
                    <td>
                        <label style="float:right">Select Category</label> 
                    </td>
                    <td>
                        <div id="exportCategory_div">
                            <select id='exportCategory' name='character' multiple='multiple' style="width: 200px;">
                                <optgroup label='Categories'></optgroup>
                            </select>
                        </div>
                    </td>
                    <td>
                        <label style="float:right">Select Features</label> 
                    </td>
                    <td>
                        <div id="exportFeatures_div">
                            <select id='exportFeatures' name='character' multiple='multiple' style="width: 200px;">
                                <optgroup label='Features'></optgroup>
                            </select>
                        </div>
                    </td>
                    <td>
                        <div id="export" onclick="exportCSV()">
                            <p class="small button filter_btn"><img src="../img/excel_icon.png" height="20px" width="20px">  Export CSV </p>
                        </div>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td><center><label id="ProductCount"></label></center></td>
                </tr>
            </tbody>
        </table>
