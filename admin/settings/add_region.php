        ...
        <center>
            ...
            <?php 
                ...
                if(!empty($_GET['action']) && $_GET['action'] == 'edit'){
                    ...
                    $region_data  = $fetch_data->fetch_assoc();
                    $page_action= $_GET['action'];
                }else if(!empty($_GET['id'])){
                    echo "Region ID ".$_GET['id_tour']. "as being recorded successfully.";
                }
            ...
            <div class="tabs-content vertical" data-tabs-content="example-vert-tabs" style="margin-left: 30%;">
                ...
                <table border="4">
                    <tbody>
                        <tr>
                           <th colspan="2">
                                <h3 style="color: #000"><center>Add/Edit Region</center></h3>
                
                           </th> 
                        </tr>
                        
                        <tr>
                            <th style="border:1px solid #000000;"><label>Region ID: </label></th>
                            <td> <input type="text" id="id" name="id" value="<?php echo $region_data['id'];?>" disabled /></td>
                        </tr>
                        <tr>
                            <th style="border:1px solid #000000;"><label>Region Name: </label></th>
                            <td > <input type="text" id="name" name="name" value="<?php echo $region_data['name'];?>" /></td>
                        </tr>
                        <tr>
                            ...
                            <td> 
                                <span style="margin-left: 21px;">
                                    <select id="active" placeholder="Active/Inactive" value=""  name="active" >
                                        <?php
                                        echo $region_data['active'];
                                            if(isset($region_data['active']) && $region_data['active'] == 0){
                                                ?>
