...
function getListing(page,order){
    ...
    $("#table_tour_list").load("fetch_subcategories.php",{"arrangeOrder":arrangeOrder,"cRows":cRows,"page":page}, function(){ //get content from PHP page
...
{
    window.location.href = "add_subcategories.php?id="+id+"&action=edit";
}
function deleteSubCategories(id)
{
    if(id != ''){
        $.post("ajax_calls.php",{request:'deleteSubCategory',id:id},function(data) {
