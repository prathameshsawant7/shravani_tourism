...
$fetch_data=mysqli_query($con,"SELECT iSeller_id,cReg_name,cPassword FROM js_seller WHERE cEmail = '".trim($cEmail)."';");
if(mysqli_num_rows($fetch_data)==1)
{
    $db             = mysqli_fetch_array($fetch_data);
    $iSeller_id     = $db['iSeller_id'];
    $cSeller_name   = $db['cReg_name'];
    $cPassword      = $db['cPassword'];
    
    
    $from = "Jewelsouk Seller Hub";
    $url = "http://www.seller.jewelsouk.com/password_recovery.php?key=".$iSeller_id."_".$cPassword;
    ...
    $body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">' 
            ...
            .'<tr>' 
            .'<th>' 
            .'<h4 class="text-center">Jewelsouk Seller Hub</h4> </th>' 
            ...
            .'<tr>' 
            .'<th>' 
            .'<BR><BR><center data-parsed=""> <img src="http://www.jewelsouk.com/img/logoNewUpload.png" align="center" class="text-center"> </center>' 
            .'<BR><BR><h1 class="text-center">Forgot Your Password?</h1>' 
            ...
            .'<tr>' 
            .'<td>' 
            .'<center data-parsed=""><a href="'.$url.'" align="center" class="text-center">Reset Password</a></center>' 
            .'</td>' 
            ...
            .'<th class="expander"></th>' 
            .'</tr>' 
            .'</table>Or paste below url on browser: <BR>'.$url.'' 
            .'</th>' 
            .'</tr>' 
            .'</tbody>' 
            .'</table>' 
    ...
    $from = "customercare@jewelsouk.com";
    $subject = "Jewelsouk Seller Hub - Password Recovery";
    $headers1 = "From: $from\n";
    $headers1 .= "Content-type: text/html;charset=iso-8859-1\r\n";
    $headers1 .= "X-Priority: 1\r\n";
    $headers1 .= "X-MSMail-Priority: High\r\n";
    $headers1 .= "X-Mailer: Jewelsouk\r\n";
      echo   $body;
    $mail = mail($cEmail, $subject, $body, $headers1 );
    exit;
    if($mail)
        header('Location: index.php?completed=forgot');
    else
        header('Location: index.php?error=Error occured - Mail not sent.');
}
else 
     header('Location: index.php?error=Email Id doesn\'t exist!');
