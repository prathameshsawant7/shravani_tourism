...
$query = "SELECT COUNT(*) FROM js_orders AS o, js_order_state_lang AS osl, "
        ...
        . "WHERE osl.id_order_state = o.current_state AND o.current_state IN (25,32,63) "
        . "AND c.id_customer = o.id_customer AND od.id_order = o.id_order "
...
$fetch_data = $mysqli_conn->prepare("SELECT id_order_state,name FROM js_order_state_lang WHERE id_order_state IN (25,32,63) ORDER BY name");
...
$query = "SELECT o.id_order,od.id_order_detail, o.reference, c.firstname, "
        . "c.lastname,osl.id_order_state, o.total_products_wt AS total, "
...
echo '<table class="table_view">'
        ...
        . '<th><center><label><b>Total</b></label><span>&nbsp;</span></center></th>'
...
if($count == 0)
{
    echo '<tr><td colspan="10"><center><b>No record found</b></center></td></tr>';
}
echo '</tbody></table>';
